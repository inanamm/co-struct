...
<body class="h-screen">
    ...
    <main class="text-csblack h-screen flex flex-col lg:flex-row" id="swup">
        <div class="flex flex-col lg:w-1/2 h-screen overflow-auto no-scrollbar">
            ...
            <nav id="third" class="hidden lg:flex justify-between pt-2 pb-5 px-3 font-sans text-lg border-t border-csblack">
                <?php
                $items = $pages->listed();
                if ($items->isNotEmpty()) :
                ?>
        ...
        <div id="gallery" class="hidden divide-y divide-csgreen lg:grid flex-col lg:flex-wrap lg:w-1/2 lg:divide-none overflow-y-auto h-full no-scrollbar">
